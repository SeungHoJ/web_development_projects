...
import MotivationalModal from "./components/MotivationModal"
    ...
    <Box sx={{
     ...
     <Container maxWidth='md' sx={{pt:'5'}}>
      <Box sx={{
        ...
        <img src={ClockImage} alt="Clock" width={265} height={265} style={{
          position: 'relative'
        }} />
        <Box sx={{
          position : 'absolute',
      ...
      <MotivationalModal open={modalOpen} handleClose={ () =>{setMoadlOpen(false)}}/>
